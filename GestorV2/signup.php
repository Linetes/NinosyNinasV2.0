<?php
    ...
    if (isset($_POST["id_token"]) && isset($_POST["rol"]) && $_SESSION["rol"] == "R01" ) {
        ...
        $client = new Google_Client(['client_id' => "942276734824-c907a2uhuv8gt798qu4bjq2i5kal2itt.apps.googleusercontent.com"]);  // Specify the CLIENT_ID of the app that accesses the backend
